    ...
    */
    ...
    private void connectToHub(DirectSocketAddress address) throws IOException {
        try {
            ...
            out.write(SmartSocketsProtocol.SERVICELINK_CONNECT);
            ...
            if (reply != SmartSocketsProtocol.CONNECTION_ACCEPTED) {
...
/*
    private void handleIncomingConnection() throws IOException {
        ...
        if (vcb == null) {
            ...
            nackVirtualConnection(index, SmartSocketsProtocol.ERROR_NO_CALLBACK);
            return;
        }
        ...
        while (getConnected()) {
            ...
            try {
                ...
                case SmartSocketsProtocol.INFO_MESSAGE:
                    ...
                    break;
/*
                case SmartSocketsProtocol.CREATE_VIRTUAL:
                    handleIncomingConnection();
                    break;

                case SmartSocketsProtocol.CREATE_VIRTUAL_ACK:
                    handleIncomingConnectionACK();
                    break;

                case SmartSocketsProtocol.CREATE_VIRTUAL_ACK_ACK:
                    handleIncomingConnectionACKACK();
                    break;

                case SmartSocketsProtocol.CREATE_VIRTUAL_NACK:
                    handleIncomingConnectionNACK();
                    break;

                case SmartSocketsProtocol.CLOSE_VIRTUAL:
                    handleIncomingClose();
                    break;

                case SmartSocketsProtocol.MESSAGE_VIRTUAL:
                    handleIncomingMessage();
                    break;

                case SmartSocketsProtocol.MESSAGE_VIRTUAL_ACK:
                    handleIncomingAck();
                    break;
*/
                case SmartSocketsProtocol.INFO_REPLY:
                    handleInfo();
                    break;

                case SmartSocketsProtocol.PROPERTY_ACK:
                    handlePropertyAck();
                    break;
    ...
    public void send(DirectSocketAddress target, DirectSocketAddress targetHub,
        ...
        try {
            synchronized (out) {
                out.write(SmartSocketsProtocol.INFO_MESSAGE);
    ...
    public void sendDataMessage(DirectSocketAddress target, DirectSocketAddress targetHub,
        ...
        try {
            synchronized (out) {
                out.write(SmartSocketsProtocol.DATA_MESSAGE);
  ...
  //      System.out.println("GOT MESSAGE: " + Arrays.deepToString(message));
    ...
    public ClientInfo[] clients(DirectSocketAddress hub, String tag)
        ...
        try {
            synchronized (out) {
                out.write(SmartSocketsProtocol.CLIENTS_FOR_HUB);
                out.writeInt(id);
    ...
    public ClientInfo[] clients(String tag) throws IOException {
        ...
        try {
            synchronized (out) {
                out.write(SmartSocketsProtocol.ALL_CLIENTS);
                out.writeInt(id);
                out.writeUTF(tag);
                out.flush();
            }
    ...
    public DirectSocketAddress[] hubs() throws IOException {
        ...
        try {
            synchronized (out) {
                out.write(SmartSocketsProtocol.HUBS);
                out.writeInt(id);
                out.flush();
            }
    ...
    public HubInfo[] hubDetails() throws IOException {
        ...
        try {
            synchronized (out) {
                out.write(SmartSocketsProtocol.HUB_DETAILS);
                out.writeInt(id);
                out.flush();
            }
    ...
    public DirectSocketAddress[] locateClient(String client) throws IOException {
        ...
        try {
            synchronized (out) {
                out.write(SmartSocketsProtocol.DIRECTION);
                out.writeInt(id);
                out.writeUTF(client);
                out.flush();
            }
...
/*
    ...
    public void createVirtualConnection(long index, DirectSocketAddress target,
        ...
        try {
            synchronized (out) {
                out.writeByte(SmartSocketsProtocol.CREATE_VIRTUAL);
    ...
    public void ackVirtualConnection(long index, int fragment, int buffer) {
        ...
        try {
            synchronized (out) {
                out.writeByte(SmartSocketsProtocol.CREATE_VIRTUAL_ACK);
                out.writeLong(index);
                out.writeInt(fragment);
                out.writeInt(buffer);
                out.flush();
    ...
    public void ackAckVirtualConnection(long index, boolean success) {
        ...
        try {
            synchronized (out) {
                out.writeByte(SmartSocketsProtocol.CREATE_VIRTUAL_ACK_ACK);
                out.writeLong(index);
    ...
    public void nackVirtualConnection(long index, byte reason) {
        ...
        try {
            synchronized (out) {
                out.write(SmartSocketsProtocol.CREATE_VIRTUAL_NACK);
                out.writeLong(index);
    ...
    public void closeVirtualConnection(long index) throws IOException {
        ...
        try {
            synchronized (out) {
                out.write(SmartSocketsProtocol.CLOSE_VIRTUAL);
                out.writeLong(index);
                out.flush();
            }
        } catch (IOException e) {
    ...
    public void sendVirtualMessage(long index, byte[] message, int off,
        ...
        try {
            synchronized (out) {
                out.write(SmartSocketsProtocol.MESSAGE_VIRTUAL);
                out.writeLong(index);
                out.writeInt(len);
    ...
    public void ackVirtualMessage(long index, int data) throws IOException {
        ...
        try {
            synchronized (out) {
                out.write(SmartSocketsProtocol.MESSAGE_VIRTUAL_ACK);
                out.writeLong(index);
                out.writeInt(data);
                out.flush();
            }
    ...
    */
    ...
    public boolean registerProperty(String tag, String value)
        ...
        try {
            synchronized (out) {
                out.write(SmartSocketsProtocol.REGISTER_PROPERTY);
                out.writeInt(id);
                out.writeUTF(tag);
                out.writeUTF(value);
                out.flush();
            ...
            return getInfoReply(id, SmartSocketsProtocol.PROPERTY_ACCEPTED);
        } catch (IOException e) {
            logger.warn("ServiceLink: Exception while writing to hub!", e);
            closeConnectionToHub();
            throw new IOException("Connection to hub lost!");
    ...
    public boolean updateProperty(String tag, String value) throws IOException {
        ...
        try {
            synchronized (out) {
                out.write(SmartSocketsProtocol.UPDATE_PROPERTY);
                out.writeInt(id);
                out.writeUTF(tag);
                out.writeUTF(value);
                out.flush();
    ...
    public boolean removeProperty(String tag) throws IOException {
        ...
        try {
            synchronized (out) {
                out.write(SmartSocketsProtocol.REMOVE_PROPERTY);
                out.writeInt(id);
                out.writeUTF(tag);
                out.flush();
            }
